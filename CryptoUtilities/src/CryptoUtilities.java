...
public final class CryptoUtilities {
    ...
    public static void powerMod(NaturalNumber n, NaturalNumber p,
        ...
        NaturalNumber o = n.newInstance();
        NaturalNumber t = n.newInstance();
        NaturalNumber copy = n.newInstance();
        NaturalNumber copyt = n.newInstance();
    ...
    public static boolean isWitnessToCompositeness(NaturalNumber w,
        ...
        NaturalNumber t = w.newInstance();
        NaturalNumber wc = w.newInstance();
        NaturalNumber wc2 = w.newInstance();
        NaturalNumber c = w.newInstance();
        boolean r = false;
    ...
    public static boolean isPrime2(NaturalNumber n) {
        ...
        int c = 0;
        boolean r = true;
        NaturalNumber nc = n.newInstance();
        NaturalNumber oc = n.newInstance();
        ...
        while (c < 20 && r) {
            ...
            nc.copyFrom(n);
            nc.decrement();
            NaturalNumber i = randomNumber(n);
            while (!(i.compareTo(oc) > 0 && i.compareTo(nc) < 0)) {
                i = randomNumber(n);
            }
            r = !isWitnessToCompositeness(i, n);
        }
